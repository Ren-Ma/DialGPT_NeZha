"""https://github.com/Tongjilibo/bert4torch/blob/master/examples/convert_script/convert_nezha_gpt_dialog.py"""
...
tf_path = '/data/PLM/nezha_gpt_dialog/model.ckpt'
torch_state_dict = {}
...
torch.save(torch_state_dict, '/data/PLM/nezha_gpt_dialog/pytorch_model.bin')
