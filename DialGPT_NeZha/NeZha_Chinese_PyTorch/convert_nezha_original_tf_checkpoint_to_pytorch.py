"""https://github.com/lonePatient/NeZha_Chinese_PyTorch/blob/main/convert_nezha_original_tf_checkpoint_to_pytorch.py"""
# coding=utf-8
...
if __name__ == "__main__":
    ...
    tf_checkpoint_path = "/data/PLM/nezha_gpt_dialog/"
    nezha_config_file = "/data/PLM/nezha_gpt_dialog/config.json"
    pytorch_dump_path = "/data/PLM/nezha_gpt_dialog/pytorch_version/"
    # convert_tf_checkpoint_to_pytorch(args.tf_checkpoint_path, args.nezha_config_file, args.pytorch_dump_path)
    convert_tf_checkpoint_to_pytorch(tf_checkpoint_path, nezha_config_file, pytorch_dump_path)
