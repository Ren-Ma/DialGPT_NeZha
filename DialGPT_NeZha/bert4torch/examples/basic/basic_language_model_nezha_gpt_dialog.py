...
# nezha配置
config_path = '/data/PLM/nezha_gpt_dialog/config.json'
checkpoint_path = '/data/PLM/nezha_gpt_dialog/pytorch_model.bin'
dict_path = '/data/PLM/nezha_gpt_dialog/vocab.txt'
