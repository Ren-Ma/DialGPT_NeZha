...
from src.TextGen.bert_layers.backend import sequence_masking
from src.TextGen.bert_layers.backend import recompute_grad
...
class Loss(Layer):
    ...
    def call(self, inputs, mask=None):
        loss = self.compute_loss(inputs, mask)  # 进去 @ ren ma 2022.11.15 
        self.add_loss(loss)
