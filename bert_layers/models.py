...
import numpy as np
from src.TextGen.bert_layers.layers import *
from src.TextGen.bert_layers.snippets import insert_arguments
from src.TextGen.bert_layers.snippets import delete_arguments
from src.TextGen.bert_layers.snippets import is_string
